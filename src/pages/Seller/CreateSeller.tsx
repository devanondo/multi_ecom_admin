...
import { Breadcrumb, Button, Card, Col, Form, Input, Row, Select, message } from 'antd';
...
import { useCreateShopMutation } from '../../redux/Shop/ShopApi';
...
const CreateSeller: React.FC = () => {
    ...
    const [createShop, response] = useCreateShopMutation();
